...
// Solidity Smart Contract for an ERC-20 Initial Coin Offering
...
contract ICO {
    ...
    constructor(address payable _governance, ERC20 _token) public {
        ...
        phaseOneSupply = SafeMath.mul(2000000, 10**(18)); // . 2,000,000 ERC-20
        phaseTwoSupply = SafeMath.mul(2000000, 10**(18)); // . 2,000,000 ERC-20
        phaseThreeSupply = SafeMath.mul(3000000, 10**(18)); // 3,000,000 ERC-20
    }
    ...
    function buyTokens(address payable beneficiary) public payable {
        ...
        require(
            weiAmount >= 0.0001 ether,
            "investment should be more than 0.0001 ETH"
        );
